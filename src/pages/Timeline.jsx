						...
						<li className="mb-12">
							...
							<div className="ml-14">
								<div className="font-medium">
									...
									that really helped me understand JavaScript and how to use it effectively in my
									projects.
									<br />
									<br />
						...
						<li className="mb-16">
							...
							<div className="ml-14">
								<div className="font-medium">
									...
									, then continued building several React projects to improve my skills. The code for
									these projects is available on my{' '}
									<a
										href="https://github.com/LucasCoppola"
										target="_blank"
										className="text-green-300"
									...
									to learn more about building complex web applications with React. This course
									provided me with a deeper understanding of React's advanced concepts and best
									practices.
								</div>
							</div>
						</li>
						...
						<li className="mb-16">
							...
							<div className="ml-14">
								<div className="font-medium">
									...
									on Frontend Masters to improve my understanding of data structures and algorithms.
									After trying other courses, I found this one to be the most comprehensive and easy
									to follow. I am applying what I learn from the course by practicing coding
